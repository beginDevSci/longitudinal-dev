...
<table class="w-full border border-gray-300 rounded-lg shadow-md bg-gray-100">
  ...
  <tbody class="text-gray-700 text-sm font-light">
    ...
    <tr class="border-b border-gray-400">
      <td class="py-3 px-6 font-semibold">Random Slopes</td>
...
### 🟢**Breaking it Down:**
    ...
    - **$X_{ij}$** → Predictor variable (e.g., time, treatment, etc.).  
...
In real-world applications, we often include **multiple predictors**, such as treatment effects, categorical variables, or interactions.
...
where:
    - **$Z_{ij}$** → Additional fixed predictor (e.g., age, gender, treatment group).  
