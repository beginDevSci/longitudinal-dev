...
<figure class="w-full text-center">
  <img src="/examples/LMM/LMM_Output.png"
       alt="Table Output" 
       class="w-full max-w-2xl h-auto mx-auto rounded-lg shadow-lg border border-gray-300">
  <figcaption class="text-gray-600 text-sm mt-2">Figure: Descriptive Statistics</figcaption>
</figure>
...
<figure class="w-full text-center bg-white p-4 rounded-lg shadow-md">
  <img src="/examples/LMM/LMM_Table.png"
       alt="Table Output" 
       class="w-full max-w-2xl h-auto mx-auto rounded-lg shadow-lg border border-gray-300">
  <figcaption class="text-gray-600 text-sm mt-2">Figure: LMM Table</figcaption>
</figure>
...
<figure class="w-full text-center bg-white p-4 rounded-lg shadow-md">
  <img src="/examples/LMM/LMM_Trajectories.png"
       alt="Table Output" 
       class="w-full max-w-2xl h-auto mx-auto rounded-lg shadow-lg border border-gray-300">
  <figcaption class="text-gray-600 text-sm mt-2">Figure: LMM Table</figcaption>
</figure>
